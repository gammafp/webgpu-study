...
const render = async (triangleOption: GPUPrimitiveTopology = 'triangle-list') => {
    ...
    // Position x, y | color
        0 + moveX, 0.5 - moveY,  1, 1, 0, 1, // Yellow
        0.5 + moveX, -0.5 - moveY,  1, 0, 0, 1, // Red
        -0.5 + moveX, -0.5 - moveY,   0, 1, 1, 1, // Cyan
    ]);
...
<template>
    <div class="d-flex flex-column justify-content-center align-items-center">
        <p class="text-center"><h3>Triangle Colored unique buffer</h3></p>
        
<p>
        In this example, we draw a triangle with colors in the screen.
        <br />
        You can use the buffer for the colors in this case we use a float32Array like data source.
    </p>
        ...
        <div class="accordion-item">
            ...
            >
                <div class="accordion-body">
                    <p>
                        The triangle have a the same buffer to print the colors and the positions.
                        <br />
                        The buffer attribute to have the color is defined in same space in the vertex shader like an unique buffer.
                        <br />
                        code:
<pre>
<code class="language-javascript">
// The position and color buffer creation:
...
// Set the position and color buffer in the passEncoder:
passEncoder.setVertexBuffer(0, vertexBuffer);
</code>
</pre>
                       </p>
